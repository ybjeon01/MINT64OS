...
// macro for video memory attribute
...
// console width, height and video memory start address
#define CONSOLE_WIDTH				80
#define CONSOLE_HEIGHT				25
#define CONSOLE_VIDEOMEMORYADDRESS	0xB8000

// video controller I/O port address
#define VGA_PORT_INDEX				0x3D4
#define VGA_PORT_DATA				0x0E
// video controller register we use
#define VGA_INDEX_UPPERCURSOR		0x0E
#define VGA_INDEX_LOWERCURSOR		0x0F

#pragma pack( push, 1 )

// structure for storing console information
typedef struct kConsoleManagerStruct {
	// location of character and cursor
