...
BOOL kIsAlphabetScanCode(BYTE bScanCode) {
	...
	if ('a' <= gs_vstKeyMappingTable[bScanCode] &&
		 gs_vstKeyMappingTable[bScanCode] <= 'z') {
		return TRUE;
	}
	return FALSE;
}
...
//
void updateCombinnationKeyStatusAndLED(BYTE bScanCode) {
    BOOL bDown;
    BYTE bDownScanCode;
...
BOOL kConverScanCodeToASCIICode(BYTE bScanCode, BYTE *pbASCIICode,
		                         BOOL *pbFlags) {
